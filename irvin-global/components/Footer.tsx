...
const services = [
  { label: 'Payday Loans', href: '#loans' },
  { label: 'Payroll Loans', href: '#loans' },
  { label: 'SME Loans', href: '#loans' },
  { label: 'Step-Up Loans', href: '#loans' },
  { label: 'Asset Financing', href: '#services' },
  { label: 'Term Deposit', href: '#services' },
  { label: 'Financial Consultancy', href: '#services' },
]

const careers = [
  { label: 'Business Development', href: '#career' },
  { label: 'Branch Services', href: '#career' },
  { label: 'Treasury & Investment', href: '#career' },
  { label: 'Technology', href: '#career' },
  { label: 'Recovery & Compliance', href: '#career' },
]
